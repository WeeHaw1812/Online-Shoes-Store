                        ...
                        <form method="post" action="AdminController">
                            <fieldset>
                                <div class="row inputblock">
                                    <div class="col-md-6">
                                        ProductID:
                                        <input  type="number" required="required" name="paraProductID" readonly="true" style="margin-left: 50px;" value="<%= pr.getProductID()%>"><br>
                                        Image:
                                        <input  type="text" required="required" name="paraImage" style="margin-left: 78px; margin-top: 10px;" value="<%= pr.getImage()%>"><br>
                                        ProductName:
                                        <input  type="text" required="required" name="paraProductName" style="margin-left: 25px; margin-top: 10px;" value="<%= pr.getProductName()%>"><br>
                                        CategoryID:
                                        <input  type="text" required="required" name="paraCategoryID" style="margin-left: 44px; margin-top: 10px;" value="<%= pr.getCategoryID()%>"><br>
                                    </div>
                                    <div class="col-md-6">
                                        BrandID:
                                        <input  type="number" required="required" name="paraBrandID" style="margin-left: 35px;" value="<%= pr.getBrandID()%>"><br>
                                        Price:
                                        <input  type="number" required="required" name="paraPrice" style="margin-left: 57px; margin-top: 10px;" value="<%= pr.getPrice()%>"><br>
                                        Description:
                                        <input  type="text" required="required" name="paraDescription" style="margin-left: 10px; margin-top: 10px;" value="<%= pr.getDescription()%>"><br>
