                        ...
                        <form method="post" action="Admin">                            
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-4">Date<input required="required" class="ml-5" style="width: 200px; height: 30px;" type="date"
                                                                 name="Date" value="<%= od.getDate()%>" id=""></div>
                                    <div class="mt-4">Address<input required="required" class="ml-4" style="width: 200px; height: 30px;" type="text"
                                                                    name="Address" value="<%= od.getAddress()%>" id=""></div>
                                    <div class="mt-4">Phone<input required="required" style="margin-left: 36px;width: 200px; height: 30px;" type="text"
                                                                  name="Phone" value="<%= od.getPhone()%>" id=""></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mt-4">TotalPrice<input required="required" style="margin-left: 41px; width: 200px; height: 30px;"
                                                                       type="text" name="TotalPrice" value="<%= od.getTotalPrice()%>" id=""></div>
                                    <div class="mt-4">DeliveryDate<input required="required" style="margin-left: 20px; width: 200px; height: 30px;" type="date"
                                                                         name="DeliveryDate" value="<%= od.getDeliveryDate()%>" id=""></div>
                                    <div class="mt-4">
                                        Status
                                        <select required="required" style="margin-left: 65px;" name="Status" value="<%= od.getStatus()%>" id="status">
