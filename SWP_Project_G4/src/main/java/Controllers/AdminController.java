    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnUpdateOrder") != null && !request.getParameter("btnUpdateOrder").equals("Submit")) {
            try {
                ...
                Date deliveryDate = Date.valueOf(request.getParameter("DeliveryDate").trim());
        ...
        if (request.getParameter("btnSubmitAddProduct") != null && request.getParameter("btnSubmitAddProduct").equals("Confirm")) {
            try {
                ...
                String image = request.getParameter("paraImage").trim();
                String productname = request.getParameter("paraProductName").trim();
                int categoryID = 1;
                String brandid = "1";
                int price = Integer.parseInt(request.getParameter("paraPrice").trim());
                String description = request.getParameter(("paraDescription").trim());
        ...
        if (request.getParameter("btnSubmitUpdate") != null && request.getParameter("btnSubmitUpdate").equals("Confirm")) {
            try {
                int id = Integer.parseInt(request.getParameter("paraProductID").trim());
                String image = request.getParameter("paraImage").trim();
                String productname = request.getParameter("paraProductName").trim();
                int categoryID = Integer.parseInt(request.getParameter("paraCategoryID").trim());
                String brandid = request.getParameter(("paraBrandID").trim());
                int price = Integer.parseInt(request.getParameter("paraPrice").trim());
                String description = request.getParameter(("paraDescription").trim());
        ...
        if (request.getParameter("btnSubmitAddImportSource") != null && request.getParameter("btnSubmitAddImportSource").equals("Confirm")) {
            try {
                int numsize = Integer.parseInt(request.getParameter("paraNumSize").trim());
                int productid = Integer.parseInt(request.getParameter("paraProductID").trim());
                int quantity = Integer.parseInt(request.getParameter("paraQuantity").trim());
        ...
        if (request.getParameter("btnSubmitUpdateImportSource") != null && request.getParameter("btnSubmitUpdateImportSource").equals("Confirm")) {
            try {
                int sizeid = Integer.parseInt(request.getParameter("paraSizeID").trim());
                int numsize = Integer.parseInt(request.getParameter("paraNumSize").trim());
                int productid = Integer.parseInt(request.getParameter("paraProductID").trim());
                int quantity = Integer.parseInt(request.getParameter("paraQuantity").trim());
