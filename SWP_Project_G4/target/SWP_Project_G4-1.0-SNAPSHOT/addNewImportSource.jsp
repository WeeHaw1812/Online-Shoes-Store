                        ...
                        <form method="post" action="AdminController">
                            <fieldset>
                                <div class="row inputblock">
                                    <div class="col-md-6">
                                        Number Of Size:
                                        <input class="inputinf" type="number" required="required" name="paraNumSize" style="margin-left: 13px; margin-top: 10px;"><br>
                                        Product ID:
                                        <input class="inputinf" type="number" required="required" name="paraProductID" style="margin-left: 50px; margin-top:10px;"><br>
                                    </div>
                                    <div class="col-md-6">
                                        Quantity:
                                        <input class="inputinf" type="number" required="required" name="paraQuantity" style="margin-left: 58px; margin-top:10px;"><br>
