                        ...
                        <form method="post" action="AdminController">
                            <fieldset>
                                <div class="row inputblock">
                                    <div class="col-md-6">
                                        Image:
                                        <input class="inputinf" type="text" required="required" name="paraImage" style="margin-left: 68px;"><br>
                                        Product Name:
                                        <input class="inputinf" type="text" required="required" name="paraProductName" style="margin-left: 10px; margin-top: 10px;"><br>
                                    </div>
                                    <div class="col-md-6">
                                        Price:
                                        <input class="inputinf" type="number" required="required" name="paraPrice" style="margin-left: 50px;"><br>
                                        Description:
                                        <input class="inputinf" type="text" required="required" name="paraDescription" style="margin-left: 5px; margin-top: 10px;"><br>
